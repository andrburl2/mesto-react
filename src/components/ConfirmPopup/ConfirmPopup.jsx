...
class ConfirmPopup extends PureComponent {
  constructor(props) {
    ...
    this.canselButton = React.createRef();    // кнопка отмены
  }
  ...
  createPromise = async () => {
    return new Promise((resolve, reject) => {
      ...
      this.canselButton.current.addEventListener('click', () => {
        resolve(false)
      });
    })
  }
      ...
      <div className={`confirm ${title ? 'confirm__is-openned' : ''}`}>
        <div className='confirm__content'>
          ...
          <div className='confirm__button-row'>
            <button className='button confirm__button confirm__button_type_cancel' onClick={onClose} ref={this.canselButton}>Назад</button>
